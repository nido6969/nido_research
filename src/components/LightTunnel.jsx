...
const LightTunnel = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn('LightTunnel WebGL init failed:', e);
      return;
    }
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uOpacity: { value: 1.0 },
        uCableColor: { value: new Float32Array([0.86, 0.73, 0.48]) },
        uPulseColor: { value: new Float32Array([0.37, 0.65, 0.54]) },
        uTunnelColor: { value: new Float32Array([0.08, 0.2, 0.16]) },
        uTunnelOpacity: { value: 0.25 },
        uGrain: { value: 1.0 },
  ...
  return <div ref={containerRef} className={`light-tunnel-container ${className}`.trim()} style={style} />;
};
