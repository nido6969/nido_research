          ...
          {featuredCards.map((card, index) => {
            ...
            return (
              <BorderGlow
                ...
                onClick={isOriginal ? () => onSelectPaper(card.rawPaper) : undefined}
                  ...
                  <div style={{
                    ...
                    <img 
                      ...
                      style={{
                        ...
                        objectFit: 'cover',
                        display: 'block',
                        transition: isOriginal ? 'transform 0.4s cubic-bezier(0.16, 1, 0.3, 1)' : 'none'
                      }}
                    />
                    ...
                    <span style={{
                      ...
                      {isOriginal ? card.badge : 'IN PROGRESS'}
                    </span>
