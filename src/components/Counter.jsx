...
export default function Counter({
  ...
  const defaultTopGradientStyle = {
    ...
    background: gradientHeight > 0 ? `linear-gradient(to bottom, ${gradientFrom}, ${gradientTo})` : 'none'
  };
  const defaultBottomGradientStyle = {
    height: gradientHeight,
    background: gradientHeight > 0 ? `linear-gradient(to top, ${gradientFrom}, ${gradientTo})` : 'none'
  };
  return (
