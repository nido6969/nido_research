              ...
              <div className="card-pad-standard">
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                  ...
                  <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'flex-start' }}>
                    ...
                    <div>
                      <strong style={{ color: '#1A1714', display: 'block', fontSize: '0.88rem' }}>Phone / WhatsApp</strong>
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexWrap: 'wrap' }}>
                          <a href={`tel:+91${INSTITUTION_INFO.contact.phone}`} style={{ fontSize: '0.85rem', color: '#234338', textDecoration: 'none' }}>
                            {INSTITUTION_INFO.contact.formattedPhone}
                          </a>
                          <a
                            href={INSTITUTION_INFO.contact.whatsappUrl}
                            target="_blank"
                            rel="noreferrer"
                            aria-label="WhatsApp"
                        ...
                        <a href="tel:+918712034644" style={{ fontSize: '0.85rem', color: '#234338', textDecoration: 'none' }}>
                          +91 87120 34644
                        </a>
                      </div>
                    </div>
