            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1.25rem' }}>
              ...
              <div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.55rem', flexWrap: 'wrap' }}>
                  <a href={`tel:+91${ABOUT_DATA.contact.phone}`} style={{ fontSize: '0.9rem', color: '#FFFFFF', textDecoration: 'none' }}>
                    {ABOUT_DATA.contact.formattedPhone || `+91 ${ABOUT_DATA.contact.phone}`}
                  </a>
                  <a
                    href={ABOUT_DATA.contact.whatsappUrl}
                    target="_blank"
                    rel="noreferrer"
                    aria-label="WhatsApp"
